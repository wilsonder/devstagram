...
@section('contenido')
        ...
        <div class="w-full md:w-8/12 lg:w-6/12 flex flex-col items-center md:flex-row">
            ...
            <div class="md:w-8/12 lg:w-6/12 px-5 flex flex-col items-center md:justify-center md:items-start py-10 md:py-10">
                ...
                <p class="text-gray-800 text-sm mb-3 font-bold mt-5">
                    ...
                    <!--la directiva choice sirve para que dependiendo de la cantidad de datos en este caso los seguidores muestre un texto especifico-->
                ...
                <p class="text-gray-800 text-sm mb-3 font-bold">
                    {{ $user->posts->count() }} <!--cantidad de post que ha realizado el usuario-->
    ...
    <!--mostrar las publicaciones que ha realizado el usuario-->
